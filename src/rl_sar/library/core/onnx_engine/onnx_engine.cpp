                                               ...
                                               const float & time_step) 
{
    ...
    try {
        ...
        // std::cout << "[ONNX engine] obs: ";
        // int i = 0;
        // std::cout << "ref dof pos: ";
        // for (i = 0; i < 29; ++i) {
        //     std::cout << obs[i] << " ";
        // }
        // std::cout << std::endl;
        // std::cout << "ref dof vel: ";
        // for (i = 29; i < 29*2; ++i){
        //     std::cout << obs[i] << " ";
        // }
        // std::cout << std::endl;

        // std::cout << "anchor_ori_b: ";
        // for (i = 58; i < 58+6; ++i){
        //     std::cout << obs[i] << " ";
        // }
        ...
        // std::cout << std::endl;
        // std::cout << "ang_vel: ";
        // for (i = 58+6; i < 58+6+3; ++i){
        //     std::cout << obs[i] << " ";
        // }
        // std::cout << std::endl;

        // std::cout << "joint_pos: ";
        // for (i = 58+6+3; i < 58+6+3+29; ++i){
        //     std::cout << obs[i] << " ";
        // }
        // std::cout << std::endl;
        // std::cout << "joint_vel: ";
        // for (i = 58+6+3+29; i < 58+6+3+29+29; ++i){
        //     std::cout << obs[i] << " ";
        // }
        // std::cout << std::endl;

        // std::cout << "action: ";
        // for (i = 58+6+3+29+29; i < 58+6+3+29+29+29; ++i){
        //     std::cout << obs[i] << " ";
        // }
        // std::cout << std::endl;
